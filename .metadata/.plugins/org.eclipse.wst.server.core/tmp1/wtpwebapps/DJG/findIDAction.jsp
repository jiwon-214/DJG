...
<jsp:setProperty name="user" property="userName" /> <%--로그인 페이지에서 넘겨준 userID를 받아서 넣어줌--%>
...
<body>
	...
	<%
		...
		String userID = userDAO.findid(user.getUserName(), user.getUserEmail()); //넘어온 아이디, 패스워드를 가지고 실행
		if (userID != null) { %>
			<div class="container" style="text-align:center;">
				<div class ="jumbotron">  
				<h3>	
					<%=user.getUserName() %> 님의 학번은 <%= userID %> 입니다.
				</h3>
				</div>
				<div class="link" style="text-align:center;">
					<a href= "login.jsp">로그인</a> | <a href= "findPW.jsp">비밀번호 찾기</a>
				</div>
			</div>
	<%	}
			...
			<div class="container" style="text-align:center;">
				...
				<div class="link" style="text-align:center;">
					<a href= "join.jsp">회원가입</a> | <a href= "findID.jsp">다시 찾기</a>
				</div>
			</div>
	<%	}
		%>
