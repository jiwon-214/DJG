	...
	<nav class ="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class = "nav navbar-nav">
				<li class><a href="main.jsp">대장금</a></li>
				<li class><a href="djg.jsp">장학금 찾기</a></li>
				<li class><a href="board.jsp">게시판</a></li>
      ...
      <div class="col-lg-4">
         <div class="jumbotron" style="padding-top:20px;">
            <form method="post" action="modificationAction.jsp">
				<h3 style = "text-align:center;">회원 정보 확인</h3>
				<%
               ...
               <div class="form-group">
               	전공
                  <input type="text" class="form-control" name="userMajor" maxlength="50" readonly="readonly" value =<%=request.getParameter("userMajor") %>>
               </div>
               <div class="form-group">
              	 학년
